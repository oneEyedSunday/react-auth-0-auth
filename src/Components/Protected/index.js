...
import { filter, flatMap, debounceTime, tap } from 'rxjs/operators';
...
class Protected extends Component {
    ...
    githubUser$ = username => from((username = this.getGithubUser(username)));

    getGithubUser = username => fetch(`https://api.github.com/users/${username}`).then(res => res.json())
